...
new_data['content'] = text_data
new_data['sentiment'] = text_classes 
...
new_data['dum_val']=1
new_data['tweet_id'] = new_data.index

new_data.sort_index(inplace=True)

train_p=new_data[['tweet_id','sentiment','dum_val',]].pivot_table(index='tweet_id',columns='sentiment')
train_p=pd.DataFrame(train_p.to_records())
train_p.columns=['tweet_id','negative','neutral','positive']
train_new=pd.merge(new_data,train_p,on='tweet_id',how='left')
train_new=train_new.drop(['sentiment','dum_val'],axis=1)
...
sample_submission.to_csv('C:/Users/DELL/Desktop/BI-LSTM/CNNandBiLSTMHCR.csv', index=False)
